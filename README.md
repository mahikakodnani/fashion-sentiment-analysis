...
## Project Overview
As an MBA Tech student at NMIMS, I developed this project to demonstrate how Natural Language Processing (NLP) can be used to transform thousands of unstructured customer reviews into actionable business intelligence. By automating sentiment detection, brands can identify product flaws, improve customer satisfaction, and optimize supply chain decisions in real-time.
